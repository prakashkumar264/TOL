        ...
        <div class="container-fluid">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                          <form id="userserach" method="POST">
							
							<div class="input-group">
								
								<div class="form-line">
									<input type="text" class="form-control" name="usrcode" placeholder="User Number" required autofocus>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-xs-4">
									<button class="btn btn-block bg-pink waves-effect" type="submit" name="submit">Search</button>
								</div>
							</div>
