    ...
    <section class="content">
        <div class="container-fluid">
			...
			<?php 
				...
				$check = "SELECT * FROM userdetail WHERE Userid = '$userid' ";
				...
				if (mysqli_num_rows($results) == 1) {
					while($row = mysqli_fetch_array($results)){
						...
						if($unqid != NULL){
							...
							$query = "SELECT pincode FROM usermaster WHERE id = '$userid' ";
							...
							$string_product = implode(',',$pincode);
							$unqid2 = $string_product.$randomString;
							
							
							
							$querycode = "select * from userdetail where UniqueId='$unqid2'";
							$results = mysqli_query($db, $querycode);
							if (mysqli_num_rows($results) == 1) {
								goto a;
							}
							else{
								
								$query2 = "UPDATE userdetail SET UniqueId = '$unqid2' where Userid='$userid' ";
