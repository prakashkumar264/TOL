    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="frame.html">TreeOfLife</a>
            </div>
                        ...
                        <div class="body">
							...
							<form id="form_validation" method="POST">
								<div class="form-group form-float">
									<div class="form-line">
										<input type="text" class="form-control" name="ConditionName" required>
										<label class="form-label">Name of Medical Condition: </label>
									</div>
								</div>
								<div class="form-group form-float">
									<div class="form-line">
							...
							<?php
								...
								$queryid = "Select * from userdetail where Userid='$userid'";
								$results = mysqli_query($db, $queryid);
								if (mysqli_num_rows($results) == 1) {
										while($row = mysqli_fetch_array($results)){
											$_SESSION['unqudi'] = $row["UniqueId"];
											
										}
								}
									
								 
								 $UniqueId = $_SESSION['unqudi'];
								
									if (isset($_POST['submit'])) {
										 $ConditionName = $_POST['ConditionName'];
										 $Diagnosis = $_POST['Diagnosis'];
										 
										$query = "INSERT INTO medicalconditionmaster(UniqueID,Userid, ConditionName, Diagnosis) VALUES ('$UniqueId','$userid','$ConditionName' ,'$Diagnosis')";
										mysqli_query($db, $query);

										echo("<script>location.href = 'medicalcondition.php';</script>");
									  }
